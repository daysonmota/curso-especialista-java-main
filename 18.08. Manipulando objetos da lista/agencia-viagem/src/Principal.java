...
//        hoteis.set(3, new Hotel("Teste", "Teste", 0));// substitui o novo objeto na posição.
        hoteis.add(3, new Hotel("Teste", "Teste", 0)); //adiciona novo objeto na lista na terceira posicao
