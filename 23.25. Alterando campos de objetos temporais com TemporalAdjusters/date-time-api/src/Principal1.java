...
public class Principal1 {
    ...
    public static void main(String[] args) {
        ...
        LocalDate dataUltimoDiaDomes =
                dataHoje.with(TemporalAdjusters.lastDayOfMonth());
        System.out.println(dataUltimoDiaDomes);

        LocalDate dataProximaSextaFeira =
                dataHoje.with(TemporalAdjusters.next(DayOfWeek.FRIDAY));
