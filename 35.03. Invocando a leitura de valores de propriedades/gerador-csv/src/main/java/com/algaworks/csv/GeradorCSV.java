    ...
    private static void imprimir(Object cliente) {
        ...
        try {
            for (Field propriedade : propriedades) {
                propriedade.setAccessible(true); //Permite visualizar o tipo de acesso que é private, por padrão não permite.
                Object resultado = propriedade.get(cliente); //pega a posição do objeto.
