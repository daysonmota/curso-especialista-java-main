...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        Contato contato5 = new Contato("Moão da Silva", "moao@algaworks.com", 80);
        Contato contato6 = new Contato("Moão da Silva", "moao@algaworks.com", 80);
        ...
        System.out.println(contato5.equals(contato6)); // false
