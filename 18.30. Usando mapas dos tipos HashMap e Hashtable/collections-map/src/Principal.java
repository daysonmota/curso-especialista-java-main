...
//      Map<Carro, Proprietario> proprietarios = new Hashtable<>(); //legado, não permite chave e valor null
...
//        proprietarios.put(null, jose);
        ...
        // Adição de valor nulo (HashMap permite, Hashtable não), posso ter vários null de valores
